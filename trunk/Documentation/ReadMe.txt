...
Select a new movie from the list on the left of the window. If there are none,
press the "+" button at the bottom of the window, or choose "New Movie" from
the File menu.
...
You can use the contextual menu (Right-click or Command-click) to reveal the 
original movie file in the Finder, then use some other program to edit it,
using Vidnik just for the initial movie capture.
...
What is missing:
  ...
  * You can't edit a title by just clicking in the text in the table of thumbnails.
